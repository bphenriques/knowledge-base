...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knowledge-base/flexsearch.min.js');loadScript('/knowledge-base/en.search-data.min.0f8ffdd77a888fbff8ba8a5b9096ef59968eabb0aad151367ef23facca10d6e8.js',function(){input.required=false;search();});}
