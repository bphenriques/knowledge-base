...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knowledge-base/flexsearch.min.js');loadScript('/knowledge-base/en.search-data.min.559aeb64d167c641ff6102e8f84a4efefaad11dbd3ca14f8eee7a1ba596a731c.js',function(){input.required=false;search();});}
