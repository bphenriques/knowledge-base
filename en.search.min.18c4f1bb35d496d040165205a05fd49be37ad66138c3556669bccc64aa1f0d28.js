...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knowledge-base/flexsearch.min.js');loadScript('/knowledge-base/en.search-data.min.68d78179819bdddbab25be9d28737813a642fabcd98cbec66000a07da86db948.js',function(){input.required=false;search();});}
