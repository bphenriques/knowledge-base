...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.02167e24ea0b5f5bcff5dadfb377d47854f18cf322ec00edeeabd77525f73a0f.js',function(){input.required=false;search();});}
