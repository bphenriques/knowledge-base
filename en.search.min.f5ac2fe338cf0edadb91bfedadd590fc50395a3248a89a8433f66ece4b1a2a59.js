...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knowledge-base/flexsearch.min.js');loadScript('/knowledge-base/en.search-data.min.451ef955e1a2f7d460add959f15d32ffb67d099a65a84ff4b23665a471aed3bc.js',function(){input.required=false;search();});}
