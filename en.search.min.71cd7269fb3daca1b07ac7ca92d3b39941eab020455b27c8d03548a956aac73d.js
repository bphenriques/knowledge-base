...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/knowledge-base/flexsearch.min.js');loadScript('/knowledge-base/en.search-data.min.796870ebf8234efcc29ea82a2a31d3600bc53a8b790b75ef65235769f29c9b82.js',function(){input.required=false;search();});}
