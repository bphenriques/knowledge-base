...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.def428e4fa1920ea21b72997a02fc1a706bac9597917753e8eb5bdeba10a9840.js',function(){input.required=false;search();});}
