...
#+BEGIN_SRC plantuml :file ../../static/anti-corruption-layer.png
actor User
...
#+RESULTS:
[[file:../../static/anti-corruption-layer.png]]
...
#+BEGIN_SRC plantuml :file ../../static/context-map.png
...
- *Aggregate*: Collection of domain objects bound to a root entity:
