...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ea72ba49685a0366c49606c4745f86b150e2337521ffa2f78fc9ae0e41c824fe.js',function(){input.required=false;search();});}
