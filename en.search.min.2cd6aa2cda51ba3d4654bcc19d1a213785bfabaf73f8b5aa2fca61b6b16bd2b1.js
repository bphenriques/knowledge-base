...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5342fbec02c8581e65680987a76f3ec377be4710a00321df404d0201263ad77f.js',function(){input.required=false;search();});}
